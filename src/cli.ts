...
function readProductArg(values: string[]): string | undefined {
...
function readFlagValue(values: string[], flag: string): string | undefined {
...
console.log(
  composeLogo("GODTECH", product.name, {
    targetCols: width,
